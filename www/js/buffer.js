          ...
          (function (r) {
            ...
            (e.kMaxLength = o),
              ...
              (r.compare = function (t, e) {
                if (
                  (j(t, Uint8Array) && (t = r.from(t, t.offset, t.byteLength)),
            ...
            function k(t) {
              return n.toByteArray(
                (function (t) {
                  if (
                    (t = (t = t.split("=")[0]).trim().replace(M, "")).length < 2
                  )
                    return "";
                  for (; t.length % 4 != 0; ) t += "=";
                  return t;
                ...
                r = Math.abs(r),
                  isNaN(r) || r === 1 / 0
                    ...
                    : ((f = Math.floor(Math.log(r) / Math.LN2)),
                      ...
                      (r += f + c >= 1 ? p / s : p * Math.pow(2, 1 - c)) * s >=
                        2 && (f++, (s /= 2)),
                      f + c >= a
                        ? ((u = 0), (f = a))
                        : f + c >= 1
        ...
        function (t, r, e) {
          (function (r) {
            ...
            (e.kMaxLength = f),
              ...
              (r.compare = function (t, e) {
                if (
                  (W(t, Uint8Array) && (t = r.from(t, t.offset, t.byteLength)),
