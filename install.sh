...
setup_poa_service() {
    ...
    # Create working directory for PoA - it expects ./data relative to working directory
    local poa_working_dir="${HOME}/proofofaccess"
    local poa_data_dir="${poa_working_dir}/data"
    mkdir -p "$poa_data_dir"
    log INFO "Created PoA working directory at $poa_working_dir"
